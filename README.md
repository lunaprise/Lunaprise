...
The image above shows the location of 18 layered Lunaprise Time Capsule Disc Systems bolted to the Odysseus lander,  which stored over 77,000 artifacts (images, mp3s, mp4 files). The image on the right shows an actual image of the Odessyus lunar lander on the south pole of the moon snapped by a Lunar camera "selfie".
